...
#include "terminal_wrapper.h"
  ...
  int main(void)
  {
    ...
    asm 
    {
        ...
        */
    	...
    	// Achtung: Andere Funktion für NQ1 und NQ5 (primary function, IRQ, 01 statt 00)
      	...
      	// andi.w oder ori.w #0xF0F0, MNP_GPIO_PNQPAR  geht nicht, deshalb folgender Code
    	...
    	move.w #0x0808, d1            // 0x800, 0x8 für falling edge
    ...
    LED1_ON:
    	...
    	move.b	d1, MNP_GPIO_SETTC				// LED einschalten 
    ...
    LED1_OFF:	
    	move.l  #~(MNP_GPIO_PORTTC_TC0),d1
    	move.b	d1, MNP_GPIO_CLRTC				// LED ausschalten
